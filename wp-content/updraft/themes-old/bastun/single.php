...
?>
<?php if(isset($bastun_redux_demo['title_single'])){?>
            ...
            <div class="col-xl-12" data-aos="fade-up" data-aos-duration="1500">
                <div class="breadcrumbarea__content__wraper">
                    <div class="breadcrumbarea__title">
                        <h2 class="heading">
                            <?php echo esc_attr($bastun_redux_demo['title_single']);?>
                        </h2>
                    </div>
                    <?php if(isset($bastun_redux_demo['subtitle_single'])){?>
                    <div class="breadcrumbarea__inner">
                        <ul>
                            ...
                            <li> 
                                <?php echo esc_attr($bastun_redux_demo['subtitle_single']);?>
                            </li>
                        </ul>
                    </div>
                    <?php } ?>
...
<div class="blog__details sp_top_140 sp_bottom_140">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 mobi-order-2">
            ...
            <?php } ?>
            <?php if ( is_active_sidebar( 'sidebar-1' ) ){?>
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 mobi-order-1" data-aos="fade-up" data-aos-duration="1500">
            <?php }else{?>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mobi-order-1" data-aos="fade-up" data-aos-duration="1500">
            <?php } ?>
...
<div class="blog__details sp_top_140 sp_bottom_140">
    <div class="container">
        <div class="row">
            <?php if ( is_active_sidebar( 'sidebar-1' ) ){?>
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12" data-aos="fade-up" data-aos-duration="1500">
            <?php }else{?>
