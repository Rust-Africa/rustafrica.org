            ...
            <div class="col-xl-12" data-aos="fade-up" data-aos-duration="1500">
                <div class="breadcrumbarea__content__wraper">
                    <div class="breadcrumbarea__title">
                        <h2 class="heading">
                            <?php printf( esc_html__( 'Search Results for: %s', 'bastun' ), get_search_query() ); ?>
                        </h2>
                    </div>
                </div>
            </div>
            ...
            <?php } ?>
                <div class="row">
                    ...
                    <div class="search-custom" >
                        <h4>
                            <?php echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'bastun' ) ;?>
                        </h4>
                        <?php get_search_form();  ?>
                    </div> 
                    <?php endif;?>
