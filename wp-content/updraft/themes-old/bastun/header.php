...
<main class="main_wrapper overflow-hidden ">
    <?php if (isset($bastun_redux_demo['repeater-animate']['redux_repeater_data']) && !empty($bastun_redux_demo['repeater-animate']['redux_repeater_data'])): ?>
    <div class="header__animate bg__black">
        <div class="container-fluid">
            <div class="header__animate__wraper">
                <?php 
                $num = count($bastun_redux_demo['repeater-animate']['redux_repeater_data']);
                $i = 0;
                for ($i=0; $i < $num ; $i++) { ?>
                <div class="header__animate__item">
                    <img src="<?php echo html_entity_decode(esc_attr($bastun_redux_demo['repeater-animate']['icon'][$i]['url'])) ?>" alt="<?php bloginfo( 'name' ); ?>">
                    <h3><?php echo html_entity_decode(esc_attr($bastun_redux_demo['repeater-animate']['title_icon'][$i])) ?></h3>
                </div>
                <?php } ?>
            </div> 
        </div>
    ...
    <?php endif ?>
    <header>
        <div class="headerarea headerarea--3 headerarea__display__none header__sticky bg__black woocommerce">
                                    ...
                                    <?php 
                                        wp_nav_menu( 
                                            array( 
                                              ...
                                              'walker'            => new bastun_wp_bootstrap_navwalker(),
                                              'before'          => '',
                                              'after'           => '',
                                              'link_before'     => '',
                                              'link_after'      => '',
            ...
            <nav class="offcanvas__menu">
                ...
                wp_nav_menu( 
                  array( 
                      ...
                      'echo'            => true,
                      'fallback_cb'       => 'wp_bootstrap_navwalker::fallback',
                      'walker'            => new bastun2_wp_bootstrap_navwalker(),
                      'before'          => '',
                      'after'           => '',
                      'link_before'     => '',
                      'link_after'      => '',
