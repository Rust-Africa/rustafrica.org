...
<main class="main_wrapper overflow-hidden woocommerce ">
    ...
    <?php endif ?>
    <header>        
        <div class="headerarea headerarea--5 bg__black header__sticky">
            <div class="container-fluid full__width__padding desktop__menu__wrapper">
