            ...
            <div class="col-xl-12" data-aos="fade-up" data-aos-duration="1500">
                <div class="breadcrumbarea__content__wraper">
                    <div class="breadcrumbarea__title">
                        <h2 class="heading">
                            <?php if(isset($bastun_redux_demo['blog_title'])){?>
                            <?php echo html_entity_decode(esc_attr($bastun_redux_demo['blog_title']));?>
                            <?php }else{?>
                            <?php echo esc_html__( 'Blog', 'bastun' ); } ?>
                        </h2>
                    </div>
                    <?php if(isset($bastun_redux_demo['blog_subtitle'])){?>
                    <div class="breadcrumbarea__inner">
                        <ul>
                            <li>
                                ...
                                <?php }else{?>
                                <?php echo esc_html__( 'Home', 'bastun' ); } ?></a>
                            </li>
                            <li><?php echo esc_html__( '//', 'bastun' ); ?> </li>
                            <li>
                                <?php echo html_entity_decode(esc_attr($bastun_redux_demo['blog_subtitle']));?>
                            </li>
                        </ul>
                    </div>
                    <?php }?>
