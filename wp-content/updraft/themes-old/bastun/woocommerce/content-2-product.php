...
?>
<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 column__custom__class column__custom__class_3_column">
        ...
        <div class="gridarea__img">
            ...
            <div class="product__grid__action">
                <ul>
                    ...
                    <li>
                        <?php $idd = get_the_ID(); echo do_shortcode( '[add_to_cart id='.$idd.']' );?>
                    </li>
                    <li>
