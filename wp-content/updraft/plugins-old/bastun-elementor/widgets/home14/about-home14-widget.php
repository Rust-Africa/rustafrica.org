 ...
 * @since 1.0.0
 */
class BdevsAboutHome14 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'About Home 14', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_Abouthome14',
			[
				'label' => esc_html__( 'About Home 14', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Why Choose Us', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);	
		$this->add_control(
			...
			[
				...
				'default'     => __( 'WE HAVE 32 YEARS OF EXPERIENCE SINCE 1986.', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);	
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'tab_title'   => esc_html__( 'About #14', 'bdevs-elementor' ),
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="about ext-about position-relative sp_top_140">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up" data-aos-duration="1800">
                <div class="about__img__wrapper about__img__wrapper--2 position-relative" data-tilt>
                    <img class="about__img__1" src="<?php print esc_url($settings['bg_image']['url']); ?>" alt="about__sass2">
