 ...
 * @since 1.0.0
 */
class BdevsSliderHome14 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Slider Home 14', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_sliderhome14',
			[
				'label' => esc_html__( 'Slider Home 14', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="herobanner d-flex align-items-center height__700 herobanner__front__img__wrapper position-relative">
    <div class="container">
