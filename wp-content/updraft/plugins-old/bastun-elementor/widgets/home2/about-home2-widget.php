 ...
 * @since 1.0.0
 */
class BdevsAboutHome2 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'About Home 2', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_Abouthome2',
			[
				'label' => esc_html__( 'About Home 2', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'QUALITY CONSULATION FOR SECURE BUSINESS. WE 32 YEAR OF EXPRIENCE.', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);	
		$this->add_control(
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="about position-relative sp_bottom_140 sp_top_140" id="about__mission__area">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up" data-aos-duration="1800">
                <div class="about__img__wrapper about__img__wrapper--2 position-relative" data-tilt>
                    ...
                    <?php if ( '' !== $settings['title_image'] )  : ?>
                    <div class="about__big__title">
                        <h1><?php echo wp_kses_post($settings['title_image']); ?></h1>
                    </div>
                    <?php endif; ?>
                    <?php if ( '' !== $settings['shape']['url'] )  : ?>
                    <div class="section__strock__line__animation">
                        <img class="ssla__animation ssl__img__3" src="<?php print esc_url($settings['shape']['url']); ?>" alt="">
                    </div>
                    <?php endif; ?>
                </div>
            </div>
