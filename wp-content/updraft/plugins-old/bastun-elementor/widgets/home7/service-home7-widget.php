 ...
 * @since 1.0.0
 */
class BdevsServiceHome7 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Service Home 7', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content_Servicehome7',
			[
				'label' => esc_html__( 'Service Home 7', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="service sp_top_120 sp_bottom_140 special__spacing" id="service__area" style="background: var(--pinkcolor) url(<?php print esc_url($settings['bg_image']['url']); ?>);">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
