 ...
 * @since 1.0.0
 */
class BdevsVideoHome7 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Video Home 7', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_Videohome7',
			[
				'label' => esc_html__( 'Video Home 7', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="video sp_bottom_120 sp_top_120" id="video__area" data-aos="fade-up">
