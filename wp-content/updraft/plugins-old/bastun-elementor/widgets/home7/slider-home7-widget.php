 ...
 * @since 1.0.0
 */
class BdevsSliderHome7 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Slider Home 7', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_sliderhome7',
			[
				'label' => esc_html__( 'Slider Home 7', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'BEST HR AGENCY', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			...
			[
				...
				'default'     => __( 'We Optimize Your Human Resource Process.', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="herobanner d-flex align-items-center height__800 herobanner__front__img__wrapper position-relative">
    <div class="container">
                ...
                <div class="row align-items-center">
                            ...
                            <div class="herobanner__button">
                                ...
                                <div class="video__button">
                                    ...
                                    <?php if ( '' !== $settings['title_video'] )  : ?>
                                   	<span class="video__button__text"> <?php echo wp_kses_post($settings['title_video']); ?></span>
                                   	<?php endif; ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xxl-6 col-xl-5 col-lg-6 col-md-12 col-sm-12">
                        <div class="herobanner__front__img" data-tilt>
                            <img src="<?php print esc_url($settings['bg_image']['url']); ?>" alt="HR">
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
