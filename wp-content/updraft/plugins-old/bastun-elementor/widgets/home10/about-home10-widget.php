 ...
 * @since 1.0.0
 */
class BdevsAboutHome10 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'About Home 10', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_Abouthome10',
			[
				'label' => esc_html__( 'About Home 10', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'I CRAFT WONDERFUL DIGITAL EXPERIENCES FOR BRAND FROM 1998.', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);	
		$this->add_control(
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="about position-relative sp_top_140 sp_bottom_140" id="about__mission__area">
    <div class="container">
        <div class="row">
            <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12" data-aos="fade-up" data-aos-duration="1500">
                <div class="about__img__wrapper position-relative" data-tilt>
                    ...
                    <div class="section__strock__line__animation">
                        ...
                        <img class="ssla__animation ssl__img__1" src="<?php print esc_url($settings['shape']['url']); ?>" alt="">
                        <?php endif; ?>
            ...
            <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12" data-aos="fade-up" data-aos-duration="2000">
                <div class="about__inner">
                    ...
                    <div class="about__text__3">
                        <p><?php echo wp_kses_post($settings['text2']); ?></p>
                    </div>
                    <?php endif; ?>
