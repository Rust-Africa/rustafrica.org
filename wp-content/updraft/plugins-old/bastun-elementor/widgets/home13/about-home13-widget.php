 ...
 * @since 1.0.0
 */
class BdevsAboutHome13 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'About Home 13', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_Abouthome13',
			[
				'label' => esc_html__( 'About Home 13', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'How we help', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);	
		$this->add_control(
			...
			[
				...
				'default'     => __( 'NEXT LEVEL ANALYTICS TO CONTROL YOUR BUSINESS.', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);	
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Welcome to our comprehensive HR solutions hub, your one-stop destination for addressing all your HR needs. Whether you are a small startup or a large corporation.', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'tab_title'   => esc_html__( 'About #13', 'bdevs-elementor' ),
				...
				'fields' => [
					[
						...
						'type'        => Controls_Manager::TEXT,
						'dynamic'     => [ 'active' => true ],
						'default'     => esc_html__( 'Hiring Solution' , 'bdevs-elementor' ),
						'label_block' => true,
					],
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="about ext-about position-relative sp_top_140 sp_bottom_140" id="tb__about">
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up" data-aos-duration="1800">
                <div class="about__img__wrapper about__img__wrapper--2 position-relative" data-tilt>
                    ...
                    <img class="about__img__1" src="<?php print esc_url($settings['bg_image']['url']); ?>" alt="about__event">
                    <?php endif ?>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up" data-aos-duration="2100">
                <div class="about__inner about__inner--2">
                    ...
                    <div class="section__title section__title--2  section__title--3  sp_bottom_20">
                    ...
                    <p class="sp_bottom_10">
                        <?php echo wp_kses_post($settings['desc']); ?></p>
                    <?php endif; ?>
