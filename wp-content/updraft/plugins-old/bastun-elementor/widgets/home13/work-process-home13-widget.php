 ...
 * @since 1.0.0
 */
class BdevsWorkProcessHome13 extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-work-process-home13';
	}
	...
	public function get_title() {
		return __( 'Work Process Home 13', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_WorkProcesshome13',
			[
				'label' => esc_html__( 'Work Process Home 13', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="work__process sp_top_140 sp_bottom_140 " style="background: var(--blackBlue) url(<?php print esc_url($settings['bg_image']['url']); ?>);">
    <div class="container">
        <div class="row">
