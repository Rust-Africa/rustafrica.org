 ...
 * @since 1.0.0
 */
class BdevsContactHome15 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Contact Home 15', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_Contacthome15',
			[
				'label' => esc_html__( 'Contact Home 15', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'subheading',
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'tab_title'   => esc_html__( 'Contact #15', 'bdevs-elementor' ),
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="contact sp_top_130 sp_bottom_140" id="tb__contact">
    <div class="container">
        <div class="row">
