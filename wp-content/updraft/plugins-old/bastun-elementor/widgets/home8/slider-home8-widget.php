 ...
 * @since 1.0.0
 */
class BdevsSliderHome8 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Slider Home 8', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_sliderhome8',
			[
				'label' => esc_html__( 'Slider Home 8', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="herobanner d-flex align-items-center height__800 bg__image position-relative herobanner__margin" style="background: url(<?php print esc_url($settings['bg_image']['url']); ?>);">
