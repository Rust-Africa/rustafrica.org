 ...
 * @since 1.0.0
 */
class BdevsBlogHome8 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Blog Home 8', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Blog Home 8', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'heading',
	...
	public function render() {
		...
		extract($settings);
		?>  
 <div class="blog sp_bottom_140 sp_top_140" id="blog__area"  data-aos="fade-up" data-aos-duration="1500">
    <div class="container">
