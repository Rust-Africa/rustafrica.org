 ...
 * @since 1.0.0
 */
class BdevsContactHome8 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Contact Home 8', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_Contacthome8',
			[
				'label' => esc_html__( 'Contact Home 8', 'bdevs-elementor' ),
			]
		);
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="contact sp_top_140 sp_bottom_140" id="tb__contact">
    <div class="container">
        <div class="row">
            <div class="col-xl-12" data-aos="fade-up" data-aos-duration="1500">
                <div class="section__title text-center sp_bottom_80">
                    ...
                    <?php } elseif('' != $settings['subheading']) { ?>
