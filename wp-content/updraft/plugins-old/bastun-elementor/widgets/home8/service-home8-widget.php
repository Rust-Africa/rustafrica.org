 ...
 * @since 1.0.0
 */
class BdevsServiceHome8 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Service Home 8', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content_Servicehome8',
			[
				'label' => esc_html__( 'Service Home 8', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'subheading',
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="service__2 sp_top_80 sp_bottom_100 special__spacing" id="service__area">
    <div class="container">
        ...
        <div class="row">
            ...
            <?php } else { ?>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up" data-aos-duration="2400">
            <?php } ?>
