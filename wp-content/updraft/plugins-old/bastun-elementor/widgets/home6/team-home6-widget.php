 ...
 * @since 1.0.0
 */
class BdevsTeamHome6 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Team Home 6', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content_Teamhome6',
			[
				'label' => esc_html__( 'Team Home 6', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'subheading',
