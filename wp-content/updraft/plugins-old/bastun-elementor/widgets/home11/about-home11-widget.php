 ...
 * @since 1.0.0
 */
class BdevsAboutHome11 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'About Home 11', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_Abouthome11',
			[
				'label' => esc_html__( 'About Home 11', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Category Home 5', 'bdevs-elementor' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'tab_title'   => esc_html__( 'Category #4', 'bdevs-elementor' ),
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="about ext-about position-relative sp_bottom_140">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up" data-aos-duration="1800">
                <div class="about__img__wrapper about__img__wrapper--2 position-relative" data-tilt>
                    <img class="about__img__1" src="<?php print esc_url($settings['bg_image']['url']); ?>" alt="about__hr">
                </div>
            </div>
            <?php endif; ?>
