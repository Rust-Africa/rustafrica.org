 ...
 * @since 1.0.0
 */
class BdevsSliderHome11 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Slider Home 11', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_sliderhome11',
			[
				'label' => esc_html__( 'Slider Home 11', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Sliders Home 11', 'bdevs-elementor' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'tab_title'   => esc_html__( 'Sliders #11', 'bdevs-elementor' ),
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="herobanner herobanner--3" id="tb__home">
