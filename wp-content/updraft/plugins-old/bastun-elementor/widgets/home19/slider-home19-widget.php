 ...
 * @since 1.0.0
 */
class BdevsSliderHome19 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Slider Home 19', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_sliderhome19',
			[
				'label' => esc_html__( 'Slider Home 19', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'International Business & Consulting.', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
		$this->add_control(
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="herobanner herobanner__with__transparent__header" style="background: url(<?php print esc_url($settings['bg_image']['url']); ?>);">
    <div class="container">
                    ...
                    <div class="col-xl-10 col-lg-12 col-md-12 col-sm-12 text-center m-auto" data-aos="fade-up" data-aos-duration="1500">
                        <div class="herobanner__content__wrapper">
                            ...
                            <div class="herobanner__text">
                                <p class="m-auto"><?php echo wp_kses_post($settings['desc']); ?></p>
                            </div>
                            <?php endif; ?>
