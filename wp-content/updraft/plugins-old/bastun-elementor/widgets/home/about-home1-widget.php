 ...
 * @since 1.0.0
 */
class BdevsAboutHome1 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'About Home 1', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_Abouthome',
			[
				'label' => esc_html__( 'About Home 1', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
	...
	public function render() {
		...
		extract($settings);
		?>  
<div class="about position-relative sp_bottom_140" id="tb__about about__mission__area">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12" data-aos="fade-up" data-aos-duration="2000">
                <div class="about__inner">
                    ...
                    <div class="about__text__2">
                        <p><?php echo wp_kses_post($settings['text1']); ?></p>
                    </div>
                    <?php endif ?>
