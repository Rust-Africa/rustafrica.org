 ...
 * @since 1.0.0
 */
class BdevsBlogHome1 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Blog Home 1', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Blog Home 1', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'heading',
	...
	public function render() {
		...
		extract($settings);
		?>  
 <div class="blog sp_bottom_140 sp_top_140 pink__bg__color aos-init aos-animate" id="blog__area"  data-aos="fade-up" data-aos-duration="1500">
    <div class="container">
			            ...
			            <?php if (wp_get_attachment_url($image_home) !='')  { ?>
			                <div class="blog__img">
			                    <a href="<?php the_permalink(); ?>">
			                        <img src="<?php echo wp_get_attachment_url($image_home);?>" alt="">
			                    </a>
			                </div>
			            <?php } else { ?>
			                <div class="blog__img">
			            ...
			            <div class="blog__content">
		                    ...
		                    <p>
		                        ...
		                        if (isset($bastun_redux_demo['blog_excerpt3'])) {
		                            echo esc_html(bastun_excerpt3($bastun_redux_demo['blog_excerpt3']));
		                        } else {
		                            echo esc_html(bastun_excerpt3(10));
		                        }
		                        ?>
		                    </p>
			            </div>
