 ...
 * @since 1.0.0
 */
class BdevsBlogHome4 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Blog Home 4', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_Bloghome4',
			[
				'label' => esc_html__( 'Blog Home 4', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'BLOG & PLANNING', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);	
		$this->add_control(
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="blog__4 sp_top_120 sp_bottom_120 white__bg special__spacing" id="tb__blogs">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xl-4 col-lg-12 col-sm-12 col-12" data-aos="fade-up" data-aos-duration="1500">
                <div class="section__title  section__title--2 blog__4__padding__right">
			...
			<?php if($i%2 == 1){?>
            <div class="col-xl-4 col-lg-6 col-sm-6 col-12" data-aos="fade-up" data-aos-duration="1800">
            <?php } else { ?>
            <div class="col-xl-4 col-lg-6 col-sm-6 col-12" data-aos="fade-up" data-aos-duration="2100">
            <?php } ?>
                <div class="blog__4__single single__transform">
