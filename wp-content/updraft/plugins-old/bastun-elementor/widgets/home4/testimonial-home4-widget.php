 ...
 * @since 1.0.0
 */
class BdevsTestimonialHome4 extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-testimonial-home4';
	}
	...
	public function get_title() {
		return __( 'Testimonial Home 4', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'Testimonial Home 4', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Testimonial Home 4', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'CUSTOMER REVIEW', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);	
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'tab_title'   => esc_html__( 'Testimonial #2', 'bdevs-elementor' ),
				...
				'fields' => [
					...
					[
						...
						'type'        => Controls_Manager::TEXTAREA,
						'dynamic'     => [ 'active' => true ],
						'default'     => esc_html__( '“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' , 'bdevs-elementor' ),
						'label_block' => true,
					],
					[
						'name'    => 'avatar',
	...
	public function render() {
		...
		extract($settings);
		?>  
<div class="testimonial testimonial__2 sp_bottom_140 sp_top_100 white__bg">
    <div class="container position-relative">
        ...
        <div class="testimonial__slider__padding position-relative row" data-aos="fade-up" data-aos-duration="1500">
