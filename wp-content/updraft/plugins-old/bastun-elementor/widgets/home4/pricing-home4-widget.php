 ...
 * @since 1.0.0
 */
class BdevsPricingHome4 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Pricing Home 4', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'Pricing Home 4', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Pricing Home 4', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( '#FFF0FA', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);	
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Pricing Monthly Home 4', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'title_monthly',
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Monthly Home 4', 'bdevs-elementor' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Pricing Yearly Home 4', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'title_yearly',
		...
		$this->add_control(
			'tabs2',
			[
				'label' => esc_html__( 'Yearly Home 4', 'bdevs-elementor' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
        ...
        <div class="row">
            <div class="col-xl-12" data-aos="fade-up" data-aos-duration="1500">
                <div class="section__title text-center  sp_bottom_50">
                	...
                	<?php } elseif('' != $settings['subheading_button']) { ?>
