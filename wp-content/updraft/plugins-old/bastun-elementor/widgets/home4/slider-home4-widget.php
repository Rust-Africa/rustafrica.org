 ...
 * @since 1.0.0
 */
class BdevsSliderHome4 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Slider Home 4', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_sliderhome4',
			[
				'label' => esc_html__( 'Slider Home 4', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'CONSULTING AGENCY', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			...
			[
				...
				'default'     => __( 'BUSINESS ADVISORY SERVICE', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
	...
	public function render() {
		...
		extract($settings);
		?> 
<div class="herobanner d-flex align-items-center height__970 herobanner__with__transparent__header" id="tb__home">
    <div class="container">
        <div class="herobanner__wrapper">

            <div class="herobanner__single">
                <div class="row align-items-center">
                    <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-duration="1500">
                    ...
                    <div class="col-xxl-7 col-xl-6 col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-duration="2000">
                        <div class="herobanner__img sp_top_90" data-tilt>
                            <img class="img-fluid" src="<?php print esc_url($settings['bg_image']['url']); ?>" alt="">
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
