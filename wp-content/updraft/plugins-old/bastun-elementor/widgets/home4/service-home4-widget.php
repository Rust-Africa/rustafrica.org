 ...
 * @since 1.0.0
 */
class BdevsServiceHome4 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Service Home 4', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content_Servicehome4',
			[
				'label' => esc_html__( 'Service Home 4', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'WE PROVIDE HIGHT QUALITY CONSULTING SERVICE', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);		
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'OTHER SERVICE', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);	
		$this->add_control(
	...
	public function render() {
		...
		extract($settings);
		?>  
<div class="service sp_top_120 sp_bottom_130 special__spacing" id="tb__service"
            style="background: var(--pinkcolor) url(<?php print esc_url($settings['bg_image']['url']); ?>);">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up" data-aos-duration="1500">
                <div class="service__single__4 single__transform">
                	<?php if ('' != $item['icon_service']['url']) { ?>
                    <div class="service__img__4">
                        <img src="<?php echo wp_kses_post($item['icon_service']['url']); ?>" alt="">
                    </div>
                    <?php } ?>
            ...
            <div class="col-xl-12" data-aos="fade-up" data-aos-duration="1500">
                <div class="service__bitton__4 text-center">
