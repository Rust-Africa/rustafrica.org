 ...
 * @since 1.0.0
 */
class BdevsSliderHome5 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Slider Home 5', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_sliderhome5',
			[
				'label' => esc_html__( 'Slider Home 5', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'WE ARE EXPERT IN THIS FIELD', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Invest Savings For Future Costing.', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
	...
	public function render() {
		...
		extract($settings);
		?> 
 <div class="herobanner d-flex align-items-center height__800 bg__image position-relative" style="background: url(<?php print esc_url($settings['bg_image']['url']); ?>);">
    <div class="container">
        <div class="herobanner__wrapper">

            <div class="herobanner__single">
                <div class="row align-items-center">
                    <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-12 col-sm-12" data-aos="fade-up" data-aos-duration="1500">
