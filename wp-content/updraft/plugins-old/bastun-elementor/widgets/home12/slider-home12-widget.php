 ...
 * @since 1.0.0
 */
class BdevsSliderHome12 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Slider Home 12', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_sliderhome12',
			[
				'label' => esc_html__( 'Slider Home 12', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'bg_image',
