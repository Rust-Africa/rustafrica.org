 ...
 * @since 1.0.0
 */
class BdevsProjectHome12 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Project Home 12', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content_Projecthome12',
			[
				'label' => esc_html__( 'Project Home 12', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'style',
			[
				'label'     => esc_html__( 'Style', 'bdevs-elementor' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'full'  => esc_html__( 'Full', 'bdevs-elementor' ),
					'container' => esc_html__( 'Container', 'bdevs-elementor' ),
				],
				'default'   => 'full',
			]
		);
...
<div class="portfolio sp_top_120 sp_bottom_120 white__bg special__spacing" id="tb__portfolio">
    <div class="container">
        ...
        <div class="row">
			...
			?>
			<?php if($i%6 == 1){?>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 single__transform filterDiv <?php echo esc_attr($cate_slug);?>" data-aos="fade-up" data-aos-duration="1500">
            <?php } elseif($i%6 == 2) { ?>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 single__transform filterDiv <?php echo esc_attr($cate_slug);?>" data-aos="fade-up" data-aos-duration="1700">
            <?php } elseif($i%6 == 3) { ?>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 single__transform filterDiv <?php echo esc_attr($cate_slug);?>" data-aos="fade-up" data-aos-duration="1900">
            <?php } elseif($i%6 == 4) { ?>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 single__transform filterDiv <?php echo esc_attr($cate_slug);?>" data-aos="fade-up" data-aos-duration="2100">
            <?php } elseif($i%6 == 5) { ?>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 single__transform filterDiv <?php echo esc_attr($cate_slug);?>" data-aos="fade-up" data-aos-duration="2300">
            <?php } else { ?>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 single__transform filterDiv <?php echo esc_attr($cate_slug);?>" data-aos="fade-up" data-aos-duration="2300">
            <?php } ?>
