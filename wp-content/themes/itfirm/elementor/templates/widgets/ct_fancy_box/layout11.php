...
?>
<div id="<?php echo esc_attr($html_id) ?>" class="ct-fancy-box ct-fancy-box-layout11 <?php echo esc_attr($settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
    <div class="item--inner">
        ...
        <?php if($settings['item_link']['url']) : ?>
            <a class="item--link" <?php ct_print_html($widget->get_render_attribute_string( 'item_link' )); ?> ></a>
        <?php endif; ?>
    </div>
</div>