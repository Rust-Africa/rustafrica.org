...
<?php if(isset($settings['testimonial']) && !empty($settings['testimonial']) && count($settings['testimonial'])): ?>
    <div class="ct-testimonial ct-testimonial-carousel9 ct-slick-slider slick-boxshadow slick-dots-style7" <?php if(!empty($settings['drap']) && $settings['drap'] !== 'false') : ?>data-cursor-label="<?php echo esc_html('DRAG', 'itfirm'); ?>"<?php endif; ?>>
                                ...
                                <div class="item--top">
                                    <div class="item--holder">
                                        ...
                                        <div class="item--meta">
                                            ...
                                            <div class="item--position"><span><?php echo esc_attr($position); ?></span></div>
                                        </div>
                                    </div>
                                    <?php if($settings['star'] == 'show') : ?>
                                        <div class="item--star">
