...
<?php if(isset($settings['testimonial']) && !empty($settings['testimonial']) && count($settings['testimonial'])): ?>
    <div id="<?php echo esc_attr($html_id); ?>" class="ct-testimonial ct-testimonial-carousel6 ct-slick-slider slick-dots-style4" <?php if($settings['drap'] !== 'false') : ?>data-cursor-label="<?php echo esc_html('DRAG', 'itfirm'); ?>"<?php endif; ?>>
