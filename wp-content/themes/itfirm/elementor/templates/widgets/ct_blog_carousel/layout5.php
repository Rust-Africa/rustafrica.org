...
if (is_array($posts)): ?>
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel ct-blog-carousel-layout5 ct-slick-slider slick-dots-<?php echo esc_attr($settings['dots_style']); ?>">
                    ...
                    <div class="item--holder">
                        <div class="item--meta">
                            <?php if($show_date == 'true' ) : ?>
                                <div class="item--date"><i class="flaticon2-calendar"></i><?php $date_formart = get_option('date_format'); echo get_the_date($date_formart, $post->ID); ?></div>
                            <?php endif; ?>
                            <?php if($show_category == 'true'): ?>
                                <div class="item--category">
                                    <i class="flaticon2-file-outline-with-text-lines"></i><?php the_terms( $post->ID, 'category', '', ' ' ); ?>
                                </div>
                            <?php endif; ?>
                        </div>
