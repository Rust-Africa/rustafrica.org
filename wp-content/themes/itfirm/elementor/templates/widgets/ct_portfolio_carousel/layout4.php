...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-portfolio-carousel4 ct-slick-slider slick-dots-style6 slick-arrows-1">
                    ...
                    <div class="grid-item-inner <?php echo esc_attr($settings['ct_animate']); ?>">
                        ...
                        <div class="item--meta">
                            ...
                            <?php if($show_button == 'true') : ?>
                                <a class="item--link" href="<?php if(!empty($portfolio_custom_link)) { echo esc_url($portfolio_custom_link); } else { echo esc_url(get_permalink( $post->ID )); } ?>"><i class="flaticon-right-arrow"></i></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
