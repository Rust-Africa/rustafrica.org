...
ct_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Blog Carousel', 'itfirm' ),
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'show_date',
                            'label' => esc_html__('Show Date', 'itfirm' ),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'true',
                        ),
                        array(
                            'name' => 'show_author',
                            'label' => esc_html__('Show Author', 'itfirm' ),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'true',
                            'condition' => [
                                'layout' => ['1','2','3','4']
                        ...
                        array(
                            'name' => 'show_comment',
                            'label' => esc_html__('Show Comment', 'itfirm' ),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'true',
                            'condition' => [
                                'layout' => '3'
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .ct-blog-carousel-layout4 .item--readmore .btn' => 'background: {{VALUE}};',
                            ],
                            'condition' => [
                                'show_button' => 'true',
                                'layout' => '4',
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'dots_style',
                            'label' => esc_html__('Dots Style', 'itfirm' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'style6',
                            'options' => [
                                'style1' => 'Style 1',
                        ...
                        array(
                            'name' => 'dots_spacer_top',
                            'label' => esc_html__('Dots Top Spacer', 'itfirm' ),
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .slick-dots' => 'margin-top: {{SIZE}}{{UNIT}} !important;',
                            ],
                            'condition' => [
                                'layout' => ['5'],
                            ],
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .ct-blog-carousel .item--title' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .ct-blog-carousel .item--title',
                        ),
                        array(
                            'name' => 'desc_color',
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .ct-blog-carousel .item--content' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .ct-blog-carousel .item--content',
                        ),
                        array(
                            'name' => 'meta_typography',
                            'label' => esc_html__('Meta Typography', 'itfirm' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .ct-blog-carousel .item--meta',
                        ),
                        array(
                            'name' => 'readmore_typography',
                            'label' => esc_html__('Readmore Typography', 'itfirm' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .ct-blog-carousel .item--readmore a',
                        ),
                    ),
                ),
            ),
